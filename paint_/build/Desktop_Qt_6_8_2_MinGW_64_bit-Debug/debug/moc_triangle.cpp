...
static constexpr auto qt_meta_stringdata_ZN8TriangleE = QtMocHelpers::stringData(
    "Triangle"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8TriangleE[] = {
...
Q_CONSTINIT const QMetaObject Triangle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8TriangleE.offsetsAndSizes,
    qt_meta_data_ZN8TriangleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8TriangleE_t,
        // Q_OBJECT / Q_GADGET
...
void *Triangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8TriangleE.stringdata0))
