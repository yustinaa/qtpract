...
static constexpr auto qt_meta_stringdata_ZN6SquareE = QtMocHelpers::stringData(
    "Square"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6SquareE[] = {
...
Q_CONSTINIT const QMetaObject Square::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6SquareE.offsetsAndSizes,
    qt_meta_data_ZN6SquareE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6SquareE_t,
        // Q_OBJECT / Q_GADGET
...
void *Square::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6SquareE.stringdata0))
