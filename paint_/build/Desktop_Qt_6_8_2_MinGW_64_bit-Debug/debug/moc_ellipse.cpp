...
static constexpr auto qt_meta_stringdata_ZN7EllipseE = QtMocHelpers::stringData(
    "Ellipse"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7EllipseE[] = {
...
Q_CONSTINIT const QMetaObject Ellipse::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7EllipseE.offsetsAndSizes,
    qt_meta_data_ZN7EllipseE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7EllipseE_t,
        // Q_OBJECT / Q_GADGET
...
void *Ellipse::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7EllipseE.stringdata0))
